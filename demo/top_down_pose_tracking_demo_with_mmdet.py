...
"""
python demo/top_down_pose_tracking_demo_with_mmdet.py configs/detection/configs/faster_rcnn/faster_rcnn_r50_fpn_2x_coco.py checkpoints/faster_rcnn_r50_fpn_2x_coco_bbox_mAP-0.384_20200504_210434-a5d8aa15.pth configs/skeleton/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/hrnet_w32_coco_256x192.py checkpoints/hrnet_w32_coco_256x192-c78dce93_20200708.pth --video-path demo/demo1.MP4 --out-video-root demo/outputs/tracking
"""
    ...
    for frame_id, cur_frame in enumerate(mmcv.track_iter_progress(video)):
        ...
        for result_ind, result in enumerate(mmdet_results):
            ...
            for i in range(len(result_filtered)):
                ...
                if (caption_ex == "bottle" or caption_ex == "cell phone"):
                    # print ("\n caption: ",caption)
