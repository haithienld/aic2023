...
train_pipeline = [
    dict(type='SampleAVAFrames', clip_len=4, frame_interval=16), # clip_len=4, frame_interval=16
...
val_pipeline = [
    dict(
        type='SampleAVAFrames', clip_len=4, frame_interval=16, test_mode=True), # clip_len=4, frame_interval=16
    dict(type='RawFrameDecode'),
...
data = dict(
    videos_per_gpu=4, # videos_per_gpu=16
    workers_per_gpu=2,
