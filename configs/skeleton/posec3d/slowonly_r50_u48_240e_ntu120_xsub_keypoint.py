...
ann_file_train = 'tools/data/aicitychallenge/custom_dataset_train.pkl'
ann_file_val = 'tools/data/aicitychallenge/custom_dataset_val.pkl'
...
data = dict(
    videos_per_gpu=2, #videos_per_gpu=10
    workers_per_gpu=2,
...
load_from = 'checkpoints/slowonly_r50_u48_240e_ntu120_xsub_keypoint-6736b03f.pth'
resume_from = None
