...
# https://github.com/open-mmlab/mmaction2/blob/master/tools/data/ava/README.md
# https://mmaction2.readthedocs.io/en/latest/detection_models.html
# python tools/train.py configs/skeleton/posec3d/slowonly_r50_u48_240e_ntu120_xsub_keypoint.py --work-dir work_dirs/slowonly_r50_u48_240e_ntu120_xsub_keypoint --validate --gpus 2 --seed 0 --deterministic

# above command removed --test-best flag 
import argparse
import copy
import os
